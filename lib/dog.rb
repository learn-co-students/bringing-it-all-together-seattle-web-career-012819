...
attr_reader :id
 ...
 def self.find_or_create_by(name:, breed:)
  ...
  #   does not create a new instance if a matching dog exists (FAILED - 12)
  #   when two dogs have the same name and different breed, it returns the correct dog (FAILED - 13)
  #   when creating a new dog with the same name as persisted dogs, it returns the correct dog (FAILED - 14)
  # .new_from_db
  #   creates an instance with corresponding attribute values (FAILED - 15)
  # .find_by_name
  #   returns an instance of dog that matches the name from the DB (FAILED - 16)
  # #update
  #   updates the record associated with a given instance (FAILED - 17)
